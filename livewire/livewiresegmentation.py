...
class LiveWireSegmentation(object):
    ...
    def _smooth_image(self):
        ...
        # Bilateral filtering considers both the spatial closeness and intensity similarity of pixels. 
        # It smooths the image by giving less weight to pixels that are farther away in both space and intensity. 
        # This helps in reducing noise while preserving the edges in the image.
